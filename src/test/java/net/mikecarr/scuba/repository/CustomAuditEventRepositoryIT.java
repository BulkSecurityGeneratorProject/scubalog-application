package net.mikecarr.scuba.repository;

import net.mikecarr.scuba.ScubaDiveLogApp;
import net.mikecarr.scuba.config.Constants;
import net.mikecarr.scuba.config.audit.AuditEventConverter;
import net.mikecarr.scuba.domain.PersistentAuditEvent;
...
import static net.mikecarr.scuba.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
